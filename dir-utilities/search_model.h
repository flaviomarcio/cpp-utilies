...
class SearchModel : public QAbstractTableModel
{
    ...
    Q_PROPERTY(SearchModelSettings* settings READ settings WRITE setSettings RESET resetSettings NOTIFY settingsChanged)
...
public:
    ...
    SearchModelSettings *settings();
    void setSettings(const SearchModelSettings *newSettings);
    void resetSettings();
